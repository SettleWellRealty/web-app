...
export default function EmailSignature() {
	...
	const useFirstNameOnly = searchParams.get("firstNameOnly") === "true";
	...
	useEffect(() => {
		// Set title from slug if available
		if (params.slug) {
			const titleFromSlug = (params.slug as string).replace(/-/g, " ");
			setFormData((prev) => ({ ...prev, title: formatTitle(titleFromSlug) }));
		}
      ...
      >
        <tbody style="border: 0 !important; outline: 0 !important;">
          <tr style="border: 0 !important; outline: 0 !important; border-spacing: 0;">
            ...
            <!-- 2) Name, Title, Company, and Tagline -->
	...
	const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		} else if (name === "title" && !params.slug) {
			// Only update title if not using slug
